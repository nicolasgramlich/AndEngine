...
public class ObjectMap<K, V> {
	...
	static public class Values<V> extends MapIterator<Object, V> implements Iterable<V>, Iterator<V> {
		...
		public SparseArray<V> toArray () {
			SparseArray<V> array = new SparseArray<V>();
		...
		public void toArray (SparseArray<V> array) {
			int i = 0;
			while (hasNext) {
				array.append(i, next());
				i++;
	...
	static public class Keys<K> extends MapIterator<K, Object> implements Iterable<K>, Iterator<K> {
		...
		public SparseArray<K> toArray () {
			SparseArray<K> array = new SparseArray<K>();
			int i = 0;
			while (hasNext) {
				array.append(i, next());
				i++;
