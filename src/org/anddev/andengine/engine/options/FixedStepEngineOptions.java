...
public class FixedStepEngineOptions extends EngineOptions {
	...
	public FixedStepEngineOptions(final boolean pFullscreen, final ScreenOrientation pScreenOrientation, final IResolutionPolicy pResolutionPolicy, final Camera pCamera, final float pStepsPerSecond) {
