...
public class CircleOutlineParticleEmitter extends BaseCircleParticleEmitter {
	...
	public void getPositionOffset(final float[] pOffset) {
		...
		pOffset[Constants.VERTEX_INDEX_X] = this.mCenterX + FloatMath.cos(random) * this.mRadiusX;
		pOffset[Constants.VERTEX_INDEX_Y] = this.mCenterY + FloatMath.sin(random) * this.mRadiusY;
	}
