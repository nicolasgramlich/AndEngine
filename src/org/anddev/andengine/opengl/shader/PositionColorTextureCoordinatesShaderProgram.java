...
public class PositionColorTextureCoordinatesShaderProgram extends ShaderProgram {
	...
	public void bind(final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
		...
		GLES20.glUniformMatrix4fv(PositionColorTextureCoordinatesShaderProgram.sUniformModelViewPositionMatrixLocation, 1, false, GLHelper.getModelViewProjectionMatrix(), 0);
