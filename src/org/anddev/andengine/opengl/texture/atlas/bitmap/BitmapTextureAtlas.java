			...
			if(bitmapTextureAtlasSource != null) {
				...
				try {
					...
					if(preMultipyAlpha) {
						...
						GLHelper.glTexSubImage2D(GLES20.GL_TEXTURE_2D, 0, bitmapTextureAtlasSource.getTexturePositionX(), bitmapTextureAtlasSource.getTexturePositionY(), bitmap, this.mPixelFormat);
					}
