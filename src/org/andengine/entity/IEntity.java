...
public interface IEntity extends IDrawHandler, IUpdateHandler, IDisposable {
	...
	/**
	 * @return Whether this entity will be drawn
	 */
	 ...
	 * 
	 * @param pVisible
	 *            Whether this entity will be drawn
	 */
	public void setVisible(final boolean pVisible);

	/**
	 * 
	 * @return Whether this entity does not update when the
	 *         {@link Engine} ticks
	 */
	 ...
	 * 
	 * @param pIgnoreUpdate
	 *            Whether this entity does not update when the
	 *            {@link Engine} ticks
	 */
	...
	/**
	 * 
	 * @return Whether to draw the children, or only draw this entity. (The
	 *         children can be set to be invisible individually, as well.)
	 * @see #setChildrenVisible(boolean)
	 */
	 ...
	 * @see #isChildrenVisible()
	 */
	public void setChildrenVisible(final boolean pChildrenVisible);

	/**
	 * 
	 * @return Whether none of the children should update when the {@link Engine} ticks. 
	 */
	public boolean isChildrenIgnoreUpdate();

	/**
	 * 
	 * @param pChildrenIgnoreUpdate Whether none of the children should update when the {@link Engine} ticks. 
	 */
	...
	/**
	 * Sets the upperleft corner to coordinates specified
	...
	/**
	 * 
	 * @return Rotation, in degrees, from the center of the object
	 */
	public float getRotation();

	/**
	 * Rotate the object from its center 
	 * @param pRotation Rotation, in degrees, from the center of the object
	 */
