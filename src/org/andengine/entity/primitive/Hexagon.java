...
public class Hexagon extends HexagonalShape {
	 ...
	 */
	public Hexagon(final float pX, final float pY, final float pSide, final VertexBufferObjectManager pVertexBufferObjectManager) {
		this(pX, pY, pSide, pVertexBufferObjectManager, DrawType.STATIC);
	}
	 ...
	 */
	public Hexagon(final float pX, final float pY, final float pSide, final VertexBufferObjectManager pVertexBufferObjectManager, final DrawType pDrawType) {
		this(pX, pY, pSide, new HighPerformanceHexagonVertexBufferObject(pVertexBufferObjectManager, Hexagon.HEXAGON_SIZE, pDrawType, true, Hexagon.VERTEXBUFFEROBJECTATTRIBUTES_DEFAULT));
	}
	...
	public static class HighPerformanceHexagonVertexBufferObject extends HighPerformanceVertexBufferObject implements IHexagonVertexBufferObject {
		...
		public HighPerformanceHexagonVertexBufferObject(VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity, final DrawType pDrawType, final boolean pManaged, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
		...
		public void onUpdateColor(final Hexagon pHexagon) {
			...
			final float packedColor = pHexagon.getColor().getABGRPackedFloat();
	...
	public static class LowMemoryHexagonVertexBufferObject extends LowMemoryVertexBufferObject implements IHexagonVertexBufferObject {
		...
		public LowMemoryHexagonVertexBufferObject(VertexBufferObjectManager pVertexBufferObjectManager, final int pCapacity, final DrawType pDrawType, final boolean pManaged, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
			super(pVertexBufferObjectManager, pCapacity, pDrawType, pManaged, pVertexBufferObjectAttributes);
		}
